...
kubectl apply -f https://raw.githubusercontent.com/kontainapp/km/v0.9.2/cloud/k8s/deploy/cm-crio-install.yaml

# deploy the runtime using kustomize
kubectl apply -f https://raw.githubusercontent.com/kontainapp/km/v0.9.2/cloud/k8s/deploy/kontain-deploy/base/kontain-deploy.yaml
